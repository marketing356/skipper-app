/**
 * GET /api/transient-requests?auth_user_id=... — This boater's own slip requests via Railway (Rule 2)
 * Auth: boater identified by auth_user_id (forwarded as X-Boater-Auth).
 */
